<template>
  <div class="bg-gray-900 py-16">
    <div class="container flex flex-col lg:flex-row mx-auto items-center">
      <div class="flex flex-auto flex-col lg:w-1/2 text-center lg:text-left">
      ...
      <div class="flex flex-auto flex-col lg:flex-row mt-8 mx-8 lg:w-1/2 text-center space-y-8 lg:space-y-0 lg:mt-0 lg:text-left">
        <ul class="text-gray-600 space-y-2 text-lg lg:flex lg:flex-auto lg:flex-col">
          <span class="text-white uppercase text-sm tracking-wide">
            sitemap
          </span>
